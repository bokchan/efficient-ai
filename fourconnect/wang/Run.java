package andreas.fourconnect.wang;
...
public class Run implements ActionListener, ItemListener {
	...
	public static JLayeredPane createLayeredBoard() {
		...
		String dir = "branches\\andreas\\fourconnect\\wang\\images\\";
		ImageIcon imageBoard = new ImageIcon(dir + "Board.gif");
	...
	public static void paintRed(int row, int col) {
		...
		int yOffset = 75 * row;
		String dir = "branches\\andreas\\fourconnect\\wang\\images\\";
		ImageIcon redIcon = new ImageIcon(dir + "Red.gif");
	...
	public static void paintBlack(int row, int col) {
		...
		int yOffset = 75 * row;
		String dir = "branches\\andreas\\fourconnect\\wang\\images\\";
		ImageIcon blackIcon = new ImageIcon(dir + "Black.gif");
